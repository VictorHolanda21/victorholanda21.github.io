---
layout: post
title:  "Utilizando Metatags"
subtitle: "O que é e como usar?"
author: Victor Holanda
date:   2017-11-13 18:00:00 -0300
category: Tecnologia
...
1. É referente ao tipo de codificação dos caracteres da página, o [`utf-8`][1] é uma codificação padrão para email, páginas web e outros locais onde os caracteres são armazenados, essa codificação permite basicamente que caracteres com [diacríticos][2], ou seja, com sinais gráficos como acentos, sejam visualizados de forma correta.

2. Trata do [viewport][3], ou a área onde o site aparece. É a área branca da janela quando é aberta o navegador. O viewport  sempre vai ter o tamanho da janela, mas as formas que serão renderizados vai depender bastante do dispositivo. Os valores de content pode ser os que seguem abaixo:
...
Você pode usar  outras tags específicas para o buscador do [Google][4] que controlam o comportamento do rastreamento e indexação das páginas, tradução automática e etc..

* Meta tags do Open Graph protocol

O [protocolo Open Graph][5] permite que qualquer página da web seja visualizado como um post normal do Facebook.
